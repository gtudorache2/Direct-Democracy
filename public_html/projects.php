			...
			<div class="card-body">	
				...
				<div class="card-text">
                    <div class="input-group mb-3">
					    <input placeholder="Project number" value="<?=$_GET['id']?>" class="form-control" id="id" /><button class="btn btn-warning" onclick="processProjectRevisions($('#id').val());">Get revisions</button>
                    </div>
                    <hr>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div id="edit-articles" style="margin-left:25px;border:1px solid lightgrey">
			...
			<hr>				
			<button class="btn btn-warning" onclick="$('#edit-articles').append('<div contenteditable class=\'form-control editor\'><br></div>Value : <input type=\'number\' value=1>')">Add enhanchment</button>
