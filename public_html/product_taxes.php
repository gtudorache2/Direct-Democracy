...
<meta content="" name="keywords">
    ...
    <div class="container">
		<div class="card card-default">
			<div class="card-body">	
				<div class="card-title h4">Vote product taxes 
				<button type="button" class="btn btn-primary" onclick="window.location.href='./product_types.php'">
    				Propose
  				</button></div>
				<div class="card-text">
                    <hr>
       ...
       async function displayTaxes() {
        ...
        console.log(taxes2)
         for(var i =0; i < taxes2.length;i++)
         {
            ...
            '<button class="btn btn-success b" onclick="voteProductTax(\''+ taxes2[i][0]+'\', 1)">Yes</button>'+
            '<button class="btn btn-warning b" onclick="voteProductTax(\''+ taxes2[i][0]+'\', 0)">Abstain</button>'+
            '<button class="btn btn-danger b" onclick="voteProductTax(\''+ taxes2[i][0]+'\',-1)">No</button>'
        ]).draw();
         }
       }
