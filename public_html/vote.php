		...
		<div class="card card-default">
			<div class="card-body">	
                ...
                <div class="input-group mb-3">
					<input placeholder="Law number" value="<?=$_GET['id']?>" class="form-control" id="id" aria-describedby="get" /><button id="get" class="btn btn-warning" onclick="processRevisions($('#id').val(), true);">Get revisions</button>
                </div>
                    <hr>
...
<div id="law-modal" class="modal  fade" tabindex="-1">
  <div class="modal-dialog modal-xl">
	...
	<script>
        ...
        {
            echo "processRevisions(".$_GET['id'].", true);";
        }
        ?>
	</script>
      <!-- Vendor JS Files -->
