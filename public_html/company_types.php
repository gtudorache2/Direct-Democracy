...
<div id="taxes-modal" class="modal  fade" tabindex="-1">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
	  ...
	  <button type="button" class="btn btn-secondary" onclick="proposeCustomTax($('#tax-id').val(), $('#tax').val());$('#taxes-modal').modal('hide')">Propose</button>
...
$(document).ready(function() {
    ...
    var table 
                ...
                success: function (csvd) {
                    ...
                    {
                        Object.assign(items[i], {"Action" : "<button class='btn btn-warning' onclick='addTax(\""+items[i].Cod+"\")'>Propose Tax</button>"});
                    }
            ...
            //    jsonobject = JSON.stringify(obj);
                    ...
                    table = $('#types').DataTable({ 
                        ...
                        columns:[
                            ...
                            {sercheable:true, title:"Code", data:"Cod"},
                            {sercheable:true, title:"Description", data:"Titlu"},
                            {sercheable:false,title:"Level", data:"Nivel"}
                             ]
                }).draw()
